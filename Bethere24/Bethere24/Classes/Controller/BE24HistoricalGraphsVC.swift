...
//                yVals.append(ChartDataEntry(x: Double(index), y: 20.0 ))
//            }
////            dayIndex -= 1
//
...
//                var dayIndex = 7
//                var maxValue: Double = 0
//                for index in 0..<statesData!.state.days.count{
////                    yVals.append(ChartDataEntry(x: Double(dayIndex), y: 20.0 ))
//                    yVals.insert(ChartDataEntry(x: Double(dayIndex), y: 20.0), at: 0)
//                    dayIndex -= 1
//                }
//
//
